...
export const fetchBlogPost = async (slug) => {
    ...
    const query = {
        content_type: 'blogPost',
        select: ['sys.updatedAt', 'fields.title', 'fields.slug', 'fields.tags', 'fields.description', 'fields.postedOn', 'fields.heroImage', 'fields.heroImageBlur', 'fields.postRichText'],
        'fields.slug': slug,
        include: 10
    }
    ...
    try {
        ...
        const { title, slug, tags, description, postedOn, heroImage, heroImageBlur, postRichText } = blogPost.fields
