...
export const useThemeChangeAnim = (augmentVariants) => {
    ...
    const backgroundElevatedColorAnimation = useAnimation()
    ...
    const backgroundElevatedColorVariants = {
        ...(augmentVariants?.backgroundElevatedColorVariants),
        initial: {
            ...augmentVariants?.backgroundElevatedColorVariants?.initial,
            backgroundColor: theme.backgroundColorElevated
        },
        switchToLightTheme: {
    ...
    useEffect(() => {
        switch (globalState.themeName) {
            case "LIGHT_THEME":
                ...
                backgroundElevatedColorAnimation.start('switchToLightTheme')
                break
            case "DARK_THEME":
                ...
                backgroundElevatedColorAnimation.start('switchToDarkTheme')
                break
        }
    ...
    return ({
        ...
        backgroundElevatedColorAnimation,
